...
const cuadroPersonaje = document.querySelector("descripcion-personaje");
...
contenedor.addEventListener("personaje-clickeado", (event)=>{
	cuadroPersonaje.nombre = event.detail.nombre;
	cuadroPersonaje.cabello = event.detail.cabello;
	cuadroPersonaje.render();
...
class miElementoPersonaje extends HTMLElement {
	constructor(){
		super();
		this.nombre = "Sergio";
		this.cabello = "Rojo";
	...
	render(){
    	...
    	<p><span class="label">Nombre: </span><span id="name">${this.nombre}</span></p>
    	<p><span class="label">Color de cabello: </span><span id="hair">${this.cabello}</span></p>
		</div>
		`
	}
...
customElements.define("descripcion-personaje", miElementoPersonaje);